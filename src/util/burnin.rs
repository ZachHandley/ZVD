...
impl BurninPosition {
    ...
    pub fn calculate_position(
        ...
        match self {
            ...
            BurninPosition::TopCenter => {
                ((frame_width as i32 - text_width as i32) / 2, margin)
            }
            BurninPosition::TopRight => {
                (frame_width as i32 - text_width as i32 - margin, margin)
            }
...
impl BurninGenerator {
        ...
        for dy in 0..height {
            for dx in 0..width {
                ...
                if px >= 0 && px < self.width as i32 && py >= 0 && py < self.height as i32 {
                    ...
                    frame_rgb[idx] = ((1.0 - alpha) * frame_rgb[idx] as f32
                        + alpha * color.r as f32) as u8;
                    frame_rgb[idx + 1] = ((1.0 - alpha) * frame_rgb[idx + 1] as f32
                        + alpha * color.g as f32) as u8;
                    frame_rgb[idx + 2] = ((1.0 - alpha) * frame_rgb[idx + 2] as f32
                        + alpha * color.b as f32) as u8;
                }
            }
        }
    }
    ...
    fn get_char_pattern(&self, ch: char) -> &[u8] {
        match ch {
            ...
            _ => &[0b11111, 0b10001, 0b10001, 0b10001, 0b10001, 0b10001, 0b11111], // Unknown char
        }
    }
